...
#MAU NGAPAIN WAYOO KETAHUAN MAU RECODE:V
#OH YAH JGN LUPA MAMPIR KE WAAA
# 083861251898 LUTHFI XD-
...
### Logoku
def banner():
    print("\x1b[0;97m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) MULTI BRUTE  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) FORCE 5.0 │  Script By LuthfixayoranaXD │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/LuthfiXayorana ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘\n")
...
def menu_log():
    ...
    if pmu in ['']:
        ...
        if pf in ['']:
            ...
            os.system('xdg-open https://wa.me/+6283861251898')
...
def menu():
    ...
    try:
        ...
        kunci = ('%s%s%s-%s%s%s-%sLUTHFIIXYZZ'%(K,kun[0],P,K,kun[1],P,K))
        pro = ''
